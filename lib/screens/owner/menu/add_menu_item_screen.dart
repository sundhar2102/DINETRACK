...
/// Form Screen to Add a New Dish / Menu Item to Restaurant
...
class _AddMenuItemScreenState extends State<AddMenuItemScreen> {
  ...
  void initState() {
    ...
    _imageUrlController = TextEditingController(
      text: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500',
    );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('🎉 Added "${newItem.name}" to menu!'),
          ),
        );
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: _inputDecoration('e.g. Truffle Butter Pasta', icon: Icons.restaurant_menu),
                validator: (val) {
              ...
              DropdownButtonFormField<String>(
                ...
                style: const TextStyle(color: Colors.white),
                decoration: _inputDecoration('Select category', icon: Icons.category_outlined),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          style: const TextStyle(color: Colors.white),
                          decoration: _inputDecoration('14.99', icon: Icons.attach_money),
                          validator: (val) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          style: const TextStyle(color: Colors.white),
                          decoration: _inputDecoration('15', icon: Icons.timer_outlined),
                        ),
                      ],
                    ),
                  ),
              ...
              TextFormField(
                ...
                maxLines: 3,
                style: const TextStyle(color: Colors.white),
                decoration: _inputDecoration('Rich handmade tagliatelle with black truffle and parmesan...'),
              ),
              const SizedBox(height: 16),

              // 5. Spiciness Level Dropdown
              const Text(
                'Spiciness Level',
                style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14),
              ),
              ...
              TextFormField(
                ...
                style: const TextStyle(color: Colors.white),
                decoration: _inputDecoration('https://images.unsplash.com/...', icon: Icons.image_outlined),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isSubmitting ? null : _submitMenuItem,
